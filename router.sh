...
echo '# Generated by iptables-save v1.6.0 on Mon Sep 23 22:50:07 2019
*nat
:PREROUTING ACCEPT [2690:133024]
...
*mangle
:PREROUTING ACCEPT [2884:152475]
:INPUT ACCEPT [2794:146233]
:FORWARD ACCEPT [0:0]
:OUTPUT ACCEPT [227:48848]
:POSTROUTING ACCEPT [227:48848]
COMMIT
# Completed on Mon Sep 23 22:50:07 2019
# Generated by iptables-save v1.6.0 on Mon Sep 23 22:50:07 2019
*filter
...
chooseInterface() {
    ...
    # Otherwise,
        ...
        chooseInterfaceCmd=(whiptail --separate-output --radiolist "Choose An Interface (press space to select)(Chose the interface that the dhcp is going to run on)" ${r} ${c} ${interfaceCount})
...
getStaticIPv4Settings() {
    ...
    if whiptail --backtitle "Calibrating network interface" --title "Static IP Address" --yesno "Do you want to use your current network settings as a static address? (chose no and write 192.168.123.1 as ip and gateway)
...
setDNS() {
    ...
    DNSchoices=$(whiptail --separate-output --menu "Select Upstream DNS Provider. To use your own, select Custom.(if you chose installing your own dns chose custom and write 127.0.0.1)" ${r} ${c} 7 \
...
echo or
echo hit Ctrl+C to stop reboot
echo -e "\n"
sleep 6
reboot
